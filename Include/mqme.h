...
public:
	...
	virtual void SetData(FOURCHARCODE id, UINT32 datalen, const BYTE *data) = NULL;

	// Returns the packet identifier
	virtual FOURCHARCODE GetID() = NULL;

	// Returns the length of the data stored in this packet
	virtual UINT32 GetDataLength() = NULL;
...
public:
	...
	virtual bool StartListening(UINT16 port) = NULL;
...
public:
	...
	virtual bool Connect(const TCHAR *address, UINT16 port, GUID *my_id = nullptr) = NULL;
